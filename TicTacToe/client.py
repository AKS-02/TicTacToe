...
def status_bar():
    ...
    if not connection_established:
        whoturn ="Waiting for Openent! -exit (Press escape)"
    elif grid.game_over:
        if grid.winner !=0:
            whoturn= " Congratulations " + player + "! | Press space to clear "
        else:
    ...
    text = font.render(f'Player 2 |  {whoturn}', True, (0,100,0),) 
